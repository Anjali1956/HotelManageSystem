...
public class Adashboard extends HttpServlet {
   ...
   out.println("</style>");
    ...
    out.println("<a href='manageRoom' class='btn'>Add Rooms</a>");
    out.println("</div>");
    out.println("<div class='card'>");
    out.println("<h3>View Bookings</h3>");
    out.println("<a href='AdminBookings' class='btn'>Check Bookings</a>");
    out.println("</div>");
    out.println("<div class='card'>");
    out.println("<h3>Manage Room</h3>");
    out.println("<a href='roomopt' class='btn'>Manage Room</a>");
    out.println("</div>");
    out.println("</div>"); 
    out.println("</body>");
    out.println("</html>");
