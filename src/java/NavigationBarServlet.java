...
out.println("</style>");
        ...
        out.println("<a href='Home' class='" + (currentPage.endsWith("/Home") ? "active" : "") + "'>Home</a>");
        out.println("<a href='AboutUsServlet' class='" + (currentPage.endsWith("/AboutUsServlet") ? "active" : "") + "'>About Us</a>");
        out.println("<a href='Gallery' class='" + (currentPage.endsWith("/Gallery") ? "active" : "") + "'>Gallery</a>");
